    ...
    <footer className="mt-6 bg-deep">
      <div className="mx-auto grid max-w-[1280px] grid-cols-[repeat(auto-fit,minmax(180px,1fr))] gap-9 px-6 py-13">
        <div className="max-w-[280px]">
          ...
          <p className="mt-3 text-[13.5px] text-deep-muted">{t("tagline")}</p>
        ...
        <div>
          <p className="text-xs font-bold uppercase tracking-[0.1em] text-deep-highlight">{t("shop")}</p>
        ...
        <div>
          <p className="text-xs font-bold uppercase tracking-[0.1em] text-deep-highlight">{t("help")}</p>
          <ul className="mt-3 flex flex-col gap-2.5">
            {HELP_LINKS.map((l) => (
              <li key={l.label}>
                <Link href={l.href} className="text-[13.5px] text-deep-muted hover:text-deep-ink">
        ...
        <div>
          <p className="text-xs font-bold uppercase tracking-[0.1em] text-deep-highlight">{t("paymentMethods")}</p>
